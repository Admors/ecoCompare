    ...
    try {
        ...
        filteredMunicipalities.forEach(m => {
            ...
            $municipalityContainer.insertAdjacentHTML("beforeend", `
                <article class="bg-white p-6 rounded-2xl shadow-md hover:shadow-xl transition-shadow duration-300 hover:scale-[1.02] transform border-2 border-${color}">
                    ...
                    <ul class="text-sm text-gray-600 space-y-1">
                        ...
                        <li>
                        <em class="fas w-4 fa-bolt mr-2 text-gray-500"></em>EPC:
